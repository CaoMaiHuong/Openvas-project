      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            ...
            <button data-toggle="modal" data-target="#addTask" @click="showModal">Add Task</button>
                  ...
                  <table aria-describedby="example1_info" role="grid" id="example1" class="table table-bordered table-striped dataTable">
                    <thead>
                      <tr role="row">
                        ...
                        <th colspan="1" rowspan="1" aria-controls="example1" tabindex="0">Status</th>
                        <th colspan="1" rowspan="1" aria-controls="example1" tabindex="0">Reports</th>
                        <th colspan="1" rowspan="1" aria-controls="example1" tabindex="0">Vulnerabilities</th>
                    ...
                    <tbody>
                      <tr class="odd" role="row" v-for="task in tasks" :key="task.id">
                        ...
                        <td class="action-edit">
                          <a style="margin-right: 20px"><i class="fa fa-pencil" style="margin-right: 5px"></i>Edit</a>
                          <a> <i class="fa fa-trash" style="margin-right: 5px"></i>Delete</a>
                        </td>
                      </tr>
                    </tbody>
